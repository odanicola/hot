...
<script>
      ...
      $("input[name='nik']").keyup(function(){
        ...
        if(nik.length==16){
          $.get("<?php echo base_url()?>eform/data_kepala_keluarga/db_search/nik/"+nik,function(res){
              if(res=="exists"){
                alert("NIK sudah terdaftar di database KPLDH.");
      ...
      $("#bpjs").keyup(function(){
        var bpjs = $("#bpjs").val();
        if(bpjs.length==13){
          $.get("<?php echo base_url()?>eform/data_kepala_keluarga/db_search/bpjs/"+bpjs,function(res){
              if(res=="exists"){
                alert("Nomor BPJS sudah terdaftar di database KPLDH.");
