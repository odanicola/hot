<div class="row">
  <div class="col-md-6">
    <table class="table table-bordered table-hover">
      ...
      <tr>
        <td>Ya</td>
        <td align="right"><a onClick="getList('Ya')" href="#tampildata"><?php echo $ya;?></a></td>
        <td align="right"><a onClick="getList('Ya')" href="#tampildata"><?php echo ($ya>0) ? number_format($ya/$jumlahorang*100,2):0; echo " %";?></a></td>
      </tr>
      <tr>
        <td>Tidak</td>
        <td align="right"><a onClick="getList('Tidak')" href="#tampildata"><?php echo $tidak;?></a></td>
        <td align="right"><a onClick="getList('Tidak')" href="#tampildata"><?php echo ($tidak>0) ? number_format($tidak/$jumlahorang*100,2):0; echo " %";?></a></td>
      </tr>
      <tr>
