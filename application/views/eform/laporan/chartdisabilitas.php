<div class="row">
  <div class="col-md-6">
    <table class="table table-bordered table-hover">
      ...
      <tr>
        <td>Ya</td>
        <td align="right"><a onClick="getList('<?php echo "Ya"?>')" href="#tampildata"><?php echo $disabilitas;?></a></td>
        <td align="right"><a onClick="getList('<?php echo "Ya"?>')" href="#tampildata"><?php echo ($disabilitas>0) ? number_format($disabilitas/$jumlahorang*100,2):0; echo " %";?></a></td>
      </tr>
      <tr>
        <td>Tidak</td>
        <td align="right"><a onClick="getList('<?php echo "Tidak"?>')" href="#tampildata"><?php echo $tdkdisabilitas;?></a></td>
        <td align="right"><a onClick="getList('<?php echo "Tidak"?>')" href="#tampildata"><?php echo ($tdkdisabilitas>0) ? number_format($tdkdisabilitas/$jumlahorang*100,2):0; echo " %";?></a></td>
      </tr>
      <tr>
