...
<script>
  $(function() {
        ...
        loadPage('<?php echo base_url()?>hot/pasien/data_pasien_edit/1/{username}', 1);
        $('#jqxTabs').on('selected', function (event) {
            var pageIndex = event.args.item + 1;
            loadPage('<?php echo base_url()?>hot/pasien/data_pasien_edit/'+pageIndex+'/{username}', pageIndex);
        });
