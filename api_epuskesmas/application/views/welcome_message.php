...
<div id="container">
	<h1>Welcome to API E-Puskesmas!</h1>
	...
	<div id="body">
		...
		<p>6. <a href="<?php echo base_url().'form/form_get_insertResep'; ?>">Insert Resep</a></p>
		<p>6. <a href="<?php echo base_url().'form/form_get_insertDiagosa'; ?>">Insert Diagnosa</a></p>
	</div>
